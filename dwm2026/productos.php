...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-fluid bg-dark">
            <div class="container w-75">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="img/sol.jpg" alt="Atardecer" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                    <img src="img/luna.jpg" alt="Luna" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                    <img src="img/eclipse.jpg" alt="Eclipse" class="d-block w-100">
                    </div>
                </div>
        ...
        <div class="container-fluid bg-dark">
            <div class="row">
                <div class="col-4"></div>
                <div class="col-4 d-flex justify-content-center" style ="color:white"><strong>@MiEmpresa-Productos</strong></div>
                <div class="col-4"></div> 
            </div>
        </div>    
